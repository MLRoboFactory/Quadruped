...
//    let blueLedChannel = PCA9685Module.Channel(rawValue: 2) else {
...
//let cycleDuration: TimeInterval = 0.10
...
//        let _ = try? module.write(channel: yellowLedChannel, dutyCycle: dutyCycle),
//        let _ = try? module.write(channel: blueLedChannel, dutyCycle: dutyCycle) else {
